    ...
    return (
        <View style={styles.container}>
            <View style={styles.notRegisterContainer}>
                <TouchableOpacity style={styles.buttonContainerReg} onPress={()=>props.onPressHow('Empresa')} >
                    <Text style={styles.buttonText}>Registrate como Empresa</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.buttonContainerReg} onPress={()=>props.onPressHow('Transportista')} >
